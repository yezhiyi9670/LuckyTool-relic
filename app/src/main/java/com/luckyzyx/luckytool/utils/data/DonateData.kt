...
class DonateData {
    ...
    fun getData(): ArrayList<DonateInfo> {
        return ArrayList<DonateInfo>().apply {
            ...
            add(DonateInfo("*淼",30.0,donateDetails(
                DonateChannelInfo("20230224-211916",CAP,30.0,"2023022422001419001450383135")
            )))
            add(DonateInfo("教父",6.66,donateDetails(
                DonateChannelInfo("20230225-005415",CWC,6.66,"10000499012023022500189770135110")
            )))
            add(DonateInfo("尘",10.0,donateDetails(
                DonateChannelInfo("20230225-150953",CWC,10.0,"10000499012023022501911668467588")
            )))
            add(DonateInfo("Hoyice",6.66,donateDetails(
                DonateChannelInfo("20230227-194215",CAP,6.66,"2023022722001429031439440847")
            )))
            ...
            add(DonateInfo("Li", 10.0, donateDetails(
                DonateChannelInfo("20230404-183814", CWC, 10.0, "10000499012023040401707385444566")
            )))
            add(DonateInfo("云啊", 66.66, donateDetails(
                DonateChannelInfo("20230406-004130", CWC, 66.66, "10000499012023040601029646275565")
            )))
        }
    }

    ...
    private fun getDonateData(): ArrayList<DInfo> {
        return ArrayList<DInfo>().apply {
            ...
            add(
                DInfo(
                    "Ba7nice", details(
                        ...
                        DCInfo("20230520-212202", CQQ, 7.77, "101000026901302305201386032620")
                    )
                )
            )
            add(
            ...
            add(
                DInfo(
                    "平民", details(
                        DCInfo("20230425-173057", CAP, 18.88, "2023042522001459691405093937")
                    )
                )
            )
            add(
                DInfo(
                    "Ching Fong", details(
                        DCInfo("20230425-173656", CAP, 5.0, "2023042522001432351442794295")
                    )
                )
            )
            add(
                DInfo(
                    "七百只田鼠", details(
                        DCInfo("20230426-232638", CAP, 20.0, "2023042622001479201424714351")
                    )
                )
            )
            add(
                DInfo(
                    "小明", details(
                        DCInfo("20230427-073846", CWC, 6.66, "10000499012023042701799418647515")
                    )
                )
            )
            add(
            ...
            add(
                DInfo(
                    "暮光闪闪", details(
                        DCInfo("20230430-022724", CWC, 5.0, "10001071012023043001068230686510")
                    )
                )
            )
            add(
                DInfo(
                    "230505", details(
                        DCInfo("20230505-191808", CWC, 6.66, "10000499012023050500897561476127")
                    )
                )
            )
            add(
                DInfo(
                    "Wittoy", details(
                        DCInfo("20230506-151404", CQQ, 6.66, "101000026901302305061393685253")
                    )
                )
            )
            add(
            ...
            add(
                DInfo(
                    "costool", details(
                        DCInfo("20230520-204334", CWC, 52.0, "10000499012023052000886213008149")
                    )
                )
            )
            add(
                DInfo(
                    "miku", details(
                        DCInfo("20230520-162508", CAP, 5.0, "2023052022001474861401677569")
                    )
                )
            )
            add(
                DInfo(
                    "E*L", details(
                        DCInfo("20230521-074021", CWC, 5.0, "10000499012023052101738090790526")
                    )
                )
            )
            add(
                DInfo(
                    "阿倫", details(
                        DCInfo("20230521-105007", CWC, 10.0, "10000499012023052100478816618116")
                    )
                )
            )
            add(

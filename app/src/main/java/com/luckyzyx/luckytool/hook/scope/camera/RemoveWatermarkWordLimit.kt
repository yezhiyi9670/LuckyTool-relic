...
object RemoveWatermarkWordLimit : YukiBaseHooker() {
    override fun onHook() {
        ...
        val clazz = when (appSet[2]) {
            "8d5b992", "38e5b1a" -> "$7"
            "c7732c4" -> "$5"
            "23-02-08 11:18", "22-10-22 12:56", "22-10-20 15:45", "23-01-05 16:32", "22-06-02 23:45", "22-12-13 11:33", "22-11-18 16:19", "22-11-17 20:43", "23-01-15 13:56", "23-01-31 15:31", "22-11-24 14:45", "23-02-06 15:15" -> "$5"
            else -> ""
        }

...
android {
    ...
    @Suppress("DEPRECATION", "ObjectLiteralToLambda")
                        ...
                        override fun execute(output: com.android.build.gradle.api.BaseVariantOutput) {
                            ...
                            if (variant.name == "release") {
                                outputImpl.outputFileName =
                                    "LuckyTool_v${variant.versionName}(${variant.versionCode}).apk"
                            }
                            if (variant.name == "debug") {
                                outputImpl.outputFileName =
                                    "LuckyTool_v${variant.versionName}(${variant.versionCode})_debug.apk"
                            }
                            println("outputFileName -> ${outputImpl.outputFileName}")
                        }
                    }
                }
            }
